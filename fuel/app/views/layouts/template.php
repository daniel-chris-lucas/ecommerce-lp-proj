...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    ...
    <body>
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="span9">
                        ...
                        <a href="<?php echo Uri::create('users/login') ?>" class="login_register">Login <span>-- or --</span> Register</a>
                        <select id="currency">
        ...
        <div class="row">
            <div class="container">
                <div id="main" class="<?php if(Uri::segment(1)=='users') echo 'span12'; else echo 'span9'; ?> about" role="main">
                    <?php echo $content ?>
                </div>
